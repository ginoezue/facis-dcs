...
// TrustGateDenialQry records one federation trust-gate rejection (ADR-18)
...
// retry entry atomically with the incident that terminates it, ADR-18 AC10)
...
// immediately before the insert. A terminal policy-endpoint denial (ADR-18
